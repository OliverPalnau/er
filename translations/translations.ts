...
export const translations: Translations = {
  en: {
    ...
    servicesHeading:
      "All-inclusive regulatory management services throughout your product’s ",
    lifecycle: "entire lifecycle.",
  ...
  zh: {
    ...
    heroDescription:
      "希望用您的医疗产品或设备开拓新市场？我们是您的端到端监管伙伴，从最初的构想到市场批准以及产品的整个生命周期。",
    contactUs: "联系我们",
    assistingQuestions:
      "我们随时为您解答任何问题或疑问。无论您是想了解更多关于我们服务的信息，需要支持，或是想提供反馈，请随时与我们联系。",
    emailPrompt:
      "请给我们发送电子邮件，我们会及时向您通报新的地区和服务范围的扩展情况。",
    serviceMarkets:
      "目前，我们仅为美国和中国市场的产品提供服务，并提供英语和中文的技术文件翻译。",
    ...
    home: "首页",
    rights: "版权所有。",
    servicesHeading: "全方位的监管管理服务贯穿您产品的",
    lifecycle: "整个生命周期。",
    servicesSubHeading: "服务美国和中国*",
    servicesDescription:
      "我们提供广泛的服务，帮助您在监管环境中导航，并确保符合行业标准。",
    ...
    serviceItems: [
      ...
      {
        name: "医学写作和出版",
        description: "创建必要的文件和报告。进行技术文件翻译。",
      },
    ...
    panelDetails: [
      {
        title: "医疗食品",
        subtitle:
          "我们处理所需的注册、许可和完整营养配方的产品生命周期管理，包括：",
        description: [
          "糖尿病",
          "呼吸系统疾病",
          "肾病",
    ...
    usaSectionTitle: "美国",
    usaSectionDescription:
      "在美国市场，我们专注于促进新药申请（NDA）和简化新药申请（ANDA）的提交。我们确保制药公司能够快速有效地提交其新药或现有药物的仿制药申请。对于NDA，我们精心编制关于安全性、有效性、标签、生产工艺和质量控制的全面信息。对于ANDA，我们重点确保在提交中展示与参考药物的生物等效性。我们的目标是支持制药领域的持续评估和改进，帮助公司更快地将安全有效的药物提供给美国各地的患者。",
    chinaSectionTitle: "中国",
    chinaSectionDescription:
      "在中国市场，我们专注于促进新药申请（NDA）。我们的专业知识确保制药公司能够有效提交其新化学药物、新生物制品、基因和细胞疗法、新疫苗以及首次在中国大陆批准的新中药的申请。值得注意的是，中国在2023年创下了一年内批准新药数量最多的记录——总共104种。这些批准涵盖了广泛的治疗领域，包括肿瘤药物、抗感染药物和中枢神经系统（CNS）药物。此外，我们确保公司能够有效利用罕见病药物和儿科药物的快速通道，满足未满足的临床需求，确保创新治疗迅速到达患者手中。",
    contactHeading: "联系我们",
    contactDescription:
      "我们随时为您解答任何问题或疑问。无论您是想了解更多关于我们服务的信息，需要支持，或是想提供反馈，请随时与我们联系。",
    contactEmailPrompt:
