        ...
        <div className="mx-auto max-w-9xl text-center w-full">
          <HeroHighlight containerClassName="w-full">
            <motion.h1
              ...
              className="text-2xl px-4 md:text-4xl lg:text-6xl font-bold text-neutral-700 dark:text-white max-w-full leading-relaxed lg:leading-snug text-center mx-auto mt-4 mb-4"
            >
              {highlightText(words)}
            </motion.h1>
          </HeroHighlight>
