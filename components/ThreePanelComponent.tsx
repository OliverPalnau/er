  ...
  return (
    <div className=" mx-auto">
      ...
      >
        {panelDetails.map((panel, index) => (
          ...
          >
            ...
            {activePanel === index && isMobile && (
              <div className="space-x-10 bg-white p-6 mx-10 px-10 mt-4 rounded-lg shadow-md">
      ...
      {!isMobile && activePanel !== null && (
        <motion.div
          className="w-full bg-white p-6 mt-4 rounded-lg shadow-md"
